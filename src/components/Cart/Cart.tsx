...
export const Cart: React.FC<TypeProps> = ({ onClick, isLoading }) => {
  const { products, onRemoveCartProduct, onToggleShowCart, showCart } =
    useCart();
  const total = useMemo(() => {
          ...
          return (
            <div className="px-2 py-3 flex items-center justify-between bg-white border-b border-gray-200">
              ...
              <div
                ...
                onClick={() => onRemoveCartProduct(product.productId)}
              >
